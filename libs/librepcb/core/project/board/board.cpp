...
std::shared_ptr<SceneData3D> Board::buildScene3D(
  ...
  data->setSilkscreenLayersTop(QSet<const librepcb::Layer*>(mSilkscreenLayersTop.begin(), mSilkscreenLayersTop.end()));
  data->setSilkscreenLayersBot(QSet<const librepcb::Layer*>(mSilkscreenLayersBot.begin(), mSilkscreenLayersBot.end()));
